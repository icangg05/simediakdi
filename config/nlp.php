...
return [
    ...
    'ambang' => [
        ...
        // Dua ambang relevansi, dan keduanya sengaja tidak punya nilai bawaan.
        //
        // Selama salah satunya kosong, seluruh artikel masuk `perlu_review`:
        // tidak ada yang otomatis dinyatakan relevan, tidak ada yang otomatis
        // dibuang dari dashboard. Itu perilaku yang benar sebelum ambangnya
        // diukur. Memasang angka tebakan lalu lupa menggantinya adalah cara
        // paling umum sebuah ambang menjadi permanen tanpa pernah diuji, dan
        // itu persis yang terjadi pada `RELEVANSI_AMBANG_KEYAKINAN` yang
        // tercantum di tiga tempat tapi tidak pernah diterapkan di satu pun.
        //
        // Isinya cosine similarity, BUKAN probabilitas. 0,82 tidak berarti
        // yakin 82%, hanya berarti lebih mirip daripada 0,79.
        //
        // Cara memilihnya ada di dokumen 05 bagian 5.1: ambang atas dari titik
        // presisi mencapai 80%, ambang bawah dari titik recall mencapai 85%,
        // keduanya pada validation set dan bukan test set.
        'relevansi_atas' => is_numeric($a = env('RELEVANSI_AMBANG_ATAS')) ? (float) $a : null,
        'relevansi_bawah' => is_numeric($b = env('RELEVANSI_AMBANG_BAWAH')) ? (float) $b : null,
    ],
